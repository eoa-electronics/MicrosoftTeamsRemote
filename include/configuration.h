...
//Alphanumerical keys are written as numbers('1') or lowercase letters in single quotation marks('a')
...
//The second an third key can be disabled for each function
